...
internal sealed class MarkTodoTaskAsPendingCommandHandler : ICommandHandler<MarkTodoTaskAsPendingCommand, TodoTaskDto>
{
    ...
    public MarkTodoTaskAsPendingCommandHandler(
    ...
    public async Task<Result<TodoTaskDto>> Handle(
        MarkTodoTaskAsPendingCommand request,
        CancellationToken cancellationToken)
    {
        ...
        todoTask.MarkAsPending(_dateTimeProvider.UtcNow);
