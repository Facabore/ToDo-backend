...
- Siempre que uses un recurso valida el idioma EN, ES: [EntityName]Resources.es.resx o [EntityName]Resources.en.resx
...
## Sin importar la base de datos debe cumplir con:
- Usar MongoDB.Driver
